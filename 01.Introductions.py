# -*- coding: utf-8 -*-
"""
Created on Mon Nov 25 11:00:00 2019

@author: bdai729
"""

"""
reference: https://matplotlib.org/tutorials/introductory/usage.html#sphx-glr-
...
# <codecell> create empty figure
fig = plt.figure()  # an empty figure with no axes
fig.suptitle('No axes on this figure')  # Add a title so we know which it is

fig, ax_lst = plt.subplots(2, 2)  # a figure with a 2x2 grid of Axes
ax_lst[0, 0].set_title("this is the first axis")
...
# <codecell> share Y col
# Share a Y axis with each row of subplots
fig, ax_lst = plt.subplots(2, 2, sharey='row')

# <codecell> share X and Y col
